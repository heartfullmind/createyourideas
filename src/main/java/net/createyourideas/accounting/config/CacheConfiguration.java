package net.createyourideas.accounting.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.createyourideas.accounting.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.createyourideas.accounting.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, net.createyourideas.accounting.domain.Feedback.class.getName());
