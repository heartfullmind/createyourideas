...
import { OutgoingsComponent } from 'app/entities/outgoings/outgoings.component';
...
describe('Component Tests', () => {
  describe('Outgoings Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.outgoings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
