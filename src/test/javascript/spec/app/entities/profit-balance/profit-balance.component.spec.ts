...
import { ProfitBalanceComponent } from 'app/entities/profit-balance/profit-balance.component';
...
describe('Component Tests', () => {
  describe('ProfitBalance Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.profitBalances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
