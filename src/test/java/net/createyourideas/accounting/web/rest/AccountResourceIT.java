...
import net.createyourideas.accounting.config.Constants;
import net.createyourideas.accounting.domain.Authority;
import net.createyourideas.accounting.domain.User;
import net.createyourideas.accounting.repository.AuthorityRepository;
import net.createyourideas.accounting.repository.UserRepository;
import net.createyourideas.accounting.security.AuthoritiesConstants;
import net.createyourideas.accounting.service.MailService;
import net.createyourideas.accounting.service.UserService;
import net.createyourideas.accounting.service.dto.PasswordChangeDTO;
import net.createyourideas.accounting.service.dto.UserDTO;
import net.createyourideas.accounting.web.rest.errors.ExceptionTranslator;
import net.createyourideas.accounting.web.rest.vm.KeyAndPasswordVM;
import net.createyourideas.accounting.web.rest.vm.ManagedUserVM;
